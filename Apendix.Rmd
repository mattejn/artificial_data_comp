...
## Visually compare unmixed cell coordinates to ground truth
...
p1=ggplot()  +geom_point(aes(x=ngd_t[combos[1,i]][,1],y=ngd_t[combos[2,i]][,1]),size=0.5,alpha=0.3)+theme_cowplot()+ylab(combos[2,i])+xlab('')+ggtitle('NGD')
p2=ggplot()  + geom_segment(data=df_ols,aes(x = X1, y = X2, xend = X1.1, yend = X2.1),colour="red",alpha=0.5)+geom_point(aes(x=df_ngd$X1,y=df_ngd$X2),size=0.5,alpha=0.3)+theme_cowplot()+ylab('')+xlab(combos[1,i])+ggtitle('OLS')
p3=ggplot()  + geom_segment(data=df_wols,aes(x = X1, y = X2, xend = X1.1, yend = X2.1),colour="red",alpha=0.5)+geom_point(aes(x=df_ngd$X1,y=df_ngd$X2),size=0.5,alpha=0.3)+theme_cowplot()+ylab('')+xlab('')+ggtitle('WOLS')
...
Error=rep(sqrt(mn),nrow(gt_t))
p1=qplot(gt_t[combos[1,i]][,1], gt_t[combos[2,i]][,1], colour=Error^2 )+ scale_colour_gradientn(limits = c(mn,mx),colours=c("blue", "yellow", "red"))+theme_void()+ggtitle('Ground Truth')
p2=qplot(ngd_t[combos[1,i]][,1], ngd_t[combos[2,i]][,1], colour=aes_engd) + scale_colour_gradientn(limits = c(mn,mx),colours=c("blue", "yellow", "red"))+theme_void()+ggtitle('NGD')
p3=qplot(wols_t[combos[1,i]][,1], wols_t[combos[2,i]][,1], colour=aes_ewols) + scale_colour_gradientn(limits = c(mn,mx),colours=c("blue", "yellow", "red"))+theme_void()+ggtitle('WOLS')
p4=qplot(ols_t[combos[1,i]][,1], ols_t[combos[2,i]][,1], colour=aes_eols) + scale_colour_gradientn(limits = c(mn,mx),colours=c("blue", "yellow", "red"))+theme_void()+ggtitle('OLS')
